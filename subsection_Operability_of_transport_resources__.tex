...
The deterministic approach has the advantage to perform assessments on historical environmental data which allow the calibration of the simulation model based on past projects but does not allow the scheduling of new projects. Contrarely, the second approach is designed to be used for planning of new projects as it is using operability probabilities. %These probabilities to work have been computed for each activity considering the workability and weather window restrictions.
