...
In this paper, one jacket foundation, four piles, two tower segments, one nacelle, one rotor hub and three rotor blades per OWT are considered. The the assembly sequence considered in the model consists in four distinct phases.
\begin{enumerate}
