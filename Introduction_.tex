...
\textbf{Methodology --}
\textit{
A stochastic simulation model has been developed where weather restrictions, distance matrix, vessel characteristics and assembly scenarios are taken into account. Both real historical weather data (from a specific offshore site) and probabilistic approaches have been implemented in the analysis.}
