...
In this paper, one jacket foundation, four piles, two tower segments, one nacelle, one rotor hub and three rotor blades per OWT are considered. There are four distinct phases in the assembly strategy considered in the simulation model.
\begin{enumerate}
