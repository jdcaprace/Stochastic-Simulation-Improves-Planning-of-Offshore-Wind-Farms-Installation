...
\begin{table}[!hbp]
\caption{Typical initial-cost breakdown of a wind farm in \%, \cite{Henderson2003}, \cite{Junginger2004}, \cite{UK10}, \cite{TCE12}, \cite{IRENA12}}
\begin{center}
\include{TableCost}
\end{center}
\label{TableTypicalCost}
\end{table}
